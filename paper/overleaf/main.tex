...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{figures/figure_1_refusal_rate.png}{Figure 1 placeholder\\Refusal rate by framing with 95\% bootstrap confidence intervals.}
...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{figures/figure_2_prompt_level_consistency.png}{Figure 2 placeholder\\Prompt-level refusal consistency heatmap.}
...
\begin{figure}[t]
  \centering
  \maybeincludegraphic{figures/figure_3_framing_sensitivity_histogram.png}{Figure 3 placeholder\\Distribution of framing sensitivity across prompts.}
